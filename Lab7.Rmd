...
```
Answer:
babies born and birth detail in North Carolina with 1000 case samples.
...
```
Answer:
non-smokers have wider spread compare to the smoker, and non-smokers have slight higher median weight.
...
```
Answer:
Since the p-value is greater than 0.05, we failed to rejected the null hypothesis.
...
```
Answer:
The cutoff age for younger mothers is 34. Mothers 35 or older are considered mature mothers.
...
Answer:
Since the p-value is 0, we reject the null hypothesis means there are some evidences
that male and female babies have some weight differences.
